...
var addr = "http://192.168.1.69:8080/video";
var quality = "1000k";

setTimeout(function() {
                var child;
        // executes `pwd`     
        child = exec(`ffmpeg -i ` + addr + ` -c copy -flags +global_header -map 0 -codec:v libx264 -profile:v main -b:v ` + quality + ` -vf scale=1920:1080 -x264opts keyint=12:min-keyint=12:scenecut=-1 -bf 0 -r 24 -f segment -segment_time 6 -segment_format_options movflags=+faststart -reset_timestamps 1 test%d.mp4`, function (error, stdout, stderr) {
